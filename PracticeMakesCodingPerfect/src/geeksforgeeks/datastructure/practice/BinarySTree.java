...
public class BinarySTree {
    ...
    Nodeasd constructTreeUtil(int pre[], Index preIndex, int key,
    ...
    Nodeasd constructTree(int pre[], int size) {
        int preIndex = 0;
    ...
    void printInorder(Nodeasd node) {
        if (node == null) {
            return;
        }
    ...
    public static void main(String[] args) {
        ...
        int size = pre.length;
        Nodeasd root = tree.constructTree(pre, size);
