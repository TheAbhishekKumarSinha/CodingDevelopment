...
public class LoginJdbcDataAccess {
	...
	public void updateUser(String[] ColumnName,String[] whereclause,String tableName,String[] columnValue,String[] whereClauseValue){
	...
	public int[] batchUpdate(final List<Users> users){
		String sql="INSERT INTO USERS(userid,username,password,unsuccessfulLoginAttempts,userLocked,userLockedReason,usercreationdate,lastlogintime) "+
				"values(?,?,?,?,?,?,?,?)";
